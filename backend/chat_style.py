...
# Модель Claude для максимальной живости ответов (актуальное имя, 3.5 снят с обслуживания)
CLAUDE_MODEL = os.getenv("CLAUDE_MODEL", "claude-sonnet-4-5-20250929").strip() or "claude-sonnet-4-5-20250929"
