...
def _ai_market_context() -> str:
    ...
    lines = [
        ...
        "Ты — Ник, крипто-наставник платформы NWICKI. Ты бывалый трейдер, прошёл не один цикл: "
        ...
        "если данных нет — прямо говоришь, а не выдумываешь. Честность важнее красивого ответа — это стиль NWICKI.",
